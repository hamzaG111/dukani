...
const testimonials = [
  {
    ...
    avatar: "م",
    text: "كنت أفقد عملاء كثيرين لأنني لا أستطيع الرد في الوقت المناسب. منذ استخدمت دُكّاني، مبيعاتي ارتفعت ٤٠٪ في أقل من شهر. المساعد يرد أحسن مني!",
    rating: 5,
    highlight: true,
  },
  {
    ...
    avatar: "ف",
    text: "الإعداد أخذ مني ٤ دقائق فقط، والمساعد يتكلم الدارجة بشكل طبيعي جداً. عملاؤتي يعتقدون أن هناك موظف حقيقي يرد عليهم!",
    rating: 5,
    highlight: false,
  },
  {
  ...
  },
  {
    ...
    avatar: "ح",
    text: "التحليلات أوضحت لي أن ٦٠٪ من العملاء يسألون عن شواحن الجوال — فأضفت تشكيلة أوسع وارتفعت مبيعاتي مباشرة!",
    rating: 5,
    highlight: false,
  },
  {
