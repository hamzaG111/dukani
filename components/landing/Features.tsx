...
const features = [
  ...
  {
    icon: "⚡",
    title: "إعداد خاطف في 5 دقائق",
    description: "بدون كود، بدون خبرة تقنية، بدون تعقيد. التاجر المغربي البسيط يُعدّ كل شيء في أقل من 5 دقائق.",
    highlight: false,
  },
  {
    icon: "🎨",
    title: "تخصيص كامل بهويتك",
    description: "شعارك، ألوانك، اسمك. صفحة الشات تبدو وكأنك بنيتها بنفسك — احترافية 100٪.",
    highlight: false,
  },
  {
    icon: "🔗",
