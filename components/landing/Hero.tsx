      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center w-full">
        ...
        >
          ...
          <div className="flex items-center gap-6 flex-wrap">
            ...
            <div>
              <p className="text-foreground font-bold text-sm">+2000 تاجر</p>
              <div className="flex items-center gap-1">
                ...
                <span className="text-muted text-xs mr-1">4.9/5</span>
              </div>
            </div>
            <div className="h-8 w-px bg-border" />
            <div>
              <p className="text-foreground font-bold text-sm">بدون بطاقة بنكية</p>
              <p className="text-muted text-xs">تجربة مجانية 14 يوم</p>
            </div>
          </div>
        </motion.div>
