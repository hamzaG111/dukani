...
const plans = [
  {
    ...
    unavailable: ["QR Code", "تحليلات متقدمة", "إزالة شعار دكاني", "دعم أولوية"],
    cta: "ابدأ مجاناً",
    highlight: false,
    badge: null,
  },
  {
    ...
    currency: "درهم/شهر",
    description: "للتاجر الذي يريد البدء بثقة",
    features: [
      "500 محادثة / شهر",
      "25 منتج",
      "رابط مخصص بدومين",
    ...
    unavailable: ["منتجات لا محدودة", "إزالة شعار دكاني", "API"],
    cta: "ابدأ بـ 99 درهم",
    highlight: false,
    badge: null,
  },
