...
const team = [
  { name: "حمزة المنصوري", role: "المؤسس والرئيس التنفيذي", avatar: "ح", bio: "رائد أعمال مغربي شغوف بتمكين التجار العرب من أحدث أدوات التكنولوجيا. أمضى ١٠ سنوات في مجال ريادة الأعمال الرقمية." },
  { name: "سارة الإدريسي", role: "مديرة المنتج", avatar: "س", bio: "خبرة ٧ سنوات في بناء منتجات SaaS. متخصصة في تجربة المستخدم العربي وتحويله إلى عميل مخلص." },
  ...
  { name: "نور بنعلي", role: "مديرة نجاح العملاء", avatar: "ن", bio: "ساعدت أكثر من ٥٠٠ تاجر على إطلاق متاجرهم الذكية. تؤمن أن نجاح عملائنا هو نجاحنا." },
];

const milestones = [
  { year: "٢٠٢٤", event: "الفكرة تولد من مشكلة حقيقية: تاجر مغربي يخسر ٣٠٠٠ درهم يومياً لأنه لا يستطيع الرد على كل العملاء" },
  { year: "مارس ٢٠٢٥", event: "إطلاق النسخة التجريبية لـ٥٠ تاجر محلي في الدار البيضاء" },
  { year: "يونيو ٢٠٢٥", event: "٥٠٠ تاجر، مبيعات تجاوزت ٢ مليون درهم عبر المنصة" },
  { year: "٢٠٢٦", event: "٢٠٠٠+ تاجر، توسع في المغرب والجزائر وتونس، جولة استثمارية جديدة" },
];
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="space-y-4 text-muted text-lg leading-relaxed">
                <p>
                  في عام ٢٠٢٤، زار مؤسسنا متجراً لبيع الأحذية الجلدية في درب عمر بالدار البيضاء. رأى التاجر يركض بين الزبائن في المحل، وهاتفه يرن بلا توقف من واتساب وانستغرام.
                </p>
                <p>
        ...
        <section className="py-20 px-6">
          <div className="max-w-2xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-muted text-lg mb-8">انضم لـ٢٠٠٠+ تاجر يبنون مستقبلهم مع دُكّاني</p>
              <a
                href="/auth/register"
