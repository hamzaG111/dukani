    ...
    faqs: [
      {
        ...
        a: "الأمر بسيط جداً! سجّل حساباً مجانياً، أدخل معلومات متجرك، أضف منتجاتك، وفي أقل من ٥ دقائق يكون مساعدك الذكي جاهزاً للرد على عملائك.",
      },
      {
      ...
      {
        q: "كم يستغرق الإعداد؟",
        a: "معظم التجار يُتمون الإعداد في أقل من ٥ دقائق. لدينا تجار أتموا الإعداد في أقل من دقيقتين!",
      },
      {
        q: "هل هناك فترة تجريبية مجانية؟",
        a: "نعم! الخطة المجانية تتيح لك ١٠٠ محادثة شهرياً بدون أي رسوم ودون الحاجة لبطاقة ائتمانية.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "نعم، يتم حفظها في لوحة تحكمك لمدة ٩٠ يوماً لتمكينك من مراجعتها وتحسين خدمتك.",
      },
      {
        ...
        <section className="pb-24 px-6">
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="text-muted mb-6">فريقنا يرد خلال أقل من ٣ ساعات</p>
              <a
