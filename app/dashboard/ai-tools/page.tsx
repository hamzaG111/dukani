      ...
      <main className="flex-1 p-6 overflow-y-auto space-y-6 max-w-4xl">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="glass rounded-2xl border border-border p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-muted text-xs">٤٧ / ٢٠٠ نص</span>
          </div>
          ...
          <p className="text-muted text-xs">١٥٣ نص متبقٍ — <a href="/pricing" className="text-gold hover:underline">ترقية للاحترافي</a> للحصول على نصوص غير محدودة</p>
        </motion.div>
      </main>
    </>
  );
