...
const conversations: Conversation[] = [
  {
    ...
    messages: [
      ...
      { from: "bot", text: "وعليكم السلام! 👋 الجبادور الجلدي البني داكن بمقاس 42 سعره 297 درهم بعد خصم 15٪ (السعر الأصلي 350 درهم). هل تريد مشاهدة باقي الألوان؟", time: "7:31" },
      { from: "user", text: "نعم، أريد مشاهدة الألوان المتوفرة", time: "7:32" },
      { from: "bot", text: "عندنا:\n• بني داكن — 297 درهم (خصم 15٪) ✅\n• بني فاتح — 350 درهم ✅\n• أسود كلاسيكي — 320 درهم ✅\n\nكل الألوان متوفرة بمقاس 42 🎉", time: "7:32" },
      { from: "user", text: "شكراً، سآخذ الجبادور البني داكن", time: "7:33" },
      { from: "bot", text: "رائع الاختيار! 🌟 اضغط هنا للتواصل مع التاجر وإتمام الطلب على واتساب:", time: "7:33" },
    ],
  ...
  },
  {
    ...
    messages: [
      ...
      { from: "bot", text: "سهلة! 😊 اختاري المنتج اللي تبغي، ثم اضغطي 'أريده' وسأوصلك مباشرة للتاجر على واتساب لإتمام الطلب في دقيقة.", time: "7:23" },
  ...
  },
  {
    ...
    messages: [
      ...
      { from: "bot", text: "مرحباً! للأسف مقاس 45 غير متوفر حالياً. المقاسات المتوفرة: 39 إلى 44 فقط. هل يناسبك مقاس آخر؟", time: "7:10" },
      { from: "user", text: "لا، أريد 45 بالضبط", time: "7:11" },
      { from: "bot", text: "أفهمك تماماً 😊 سأُعلم التاجر بطلبك لمقاس 45 — يمكنه إعلامك عند توفره. هل تريد أن أترك له رسالة؟", time: "7:11" },
  ...
  },
  {
    ...
    status: "browsing",
    messages: [
      { from: "user", text: "مرحبا، أريد أعرف عن جودة الجلد", time: "6:45" },
      { from: "bot", text: "أهلاً! 🌟 الجبادور مصنوع من جلد طبيعي أصلي، متين ومريح. مصنوع يدوياً من قبل حرفيين مغاربة بخبرة 20 سنة.", time: "6:45" },
      { from: "user", text: "ممتاز، سأتواصل معكم لاحقاً", time: "6:46" },
    ],
  ...
  },
  {
    ...
    status: "ended",
    messages: [
      { from: "user", text: "كم سعر الجبادور؟", time: "6:10" },
      { from: "bot", text: "سعر الجبادور الجلدي 297 درهم بعد الخصم 🎉 جودة ممتازة بسعر مناسب جداً!", time: "6:10" },
      { from: "user", text: "مبغيتش، سعرو غالي", time: "6:11" },
    ],
