...
const stories = [
  {
    ...
    avatar: "م",
    before: { revenue: "8000", responses: "40٪", sleepHours: "5" },
    after: { revenue: "28000", responses: "100٪", sleepHours: "8" },
    growth: "250٪",
    duration: "3 أشهر",
    ...
    longStory: `كان محمد يبيع الأحذية الجلدية اليدوية منذ 15 عاماً. المشكلة الكبرى كانت أنه وحده يدير المتجر، ولا يستطيع الرد على كل رسائل واتساب وانستغرام في نفس الوقت.

في اليوم الأول بعد تثبيت دُكّاني، باع 3 أزواج بدون ما يرد على أي رسالة بنفسه. الذكاء الاصطناعي تكلم الدارجة مثله تماماً، عرف أسعار المنتجات، واقترح للعميل الحجم المناسب.

بعد 3 أشهر، تضاعفت مبيعاته 2.5 مرة. الآن لديه وقت للتركيز على صنع منتجات أفضل.`,
    tags: ["أحذية", "الدار البيضاء", "تاجر فردي"],
    metrics: [
      { label: "مبيعات شهرية", before: "8000 د.م", after: "28000 د.م" },
      { label: "معدل الرد", before: "40٪", after: "100٪" },
      { label: "ساعات نوم", before: "5 ساعات", after: "8 ساعات" },
      { label: "رضا العملاء", before: "3.8/5", after: "4.9/5" },
    ],
  },
  {
    id: "argan",
    ...
    avatar: "ف",
    before: { revenue: "12000", responses: "35٪", sleepHours: "4" },
    after: { revenue: "45000", responses: "100٪", sleepHours: "8" },
    growth: "275٪",
    duration: "4 أشهر",
...
في الشهر الثالث، بدأت تستقبل طلبات من فرنسا وبلجيكا وكندا. الآن صدّرت لأكثر من 20 دولة.`,
    tags: ["منتجات طبيعية", "مراكش", "تصدير"],
    metrics: [
      { label: "مبيعات شهرية", before: "12000 د.م", after: "45000 د.م" },
      { label: "دول التصدير", before: "1", after: "20+" },
      { label: "لغات الرد", before: "1", after: "3" },
      { label: "طلبات يومية", before: "12", after: "58" },
    ],
  },
  {
    id: "honey",
    ...
    category: "عسل وزيوت",
    avatar: "أ",
    before: { revenue: "6000", responses: "25٪", sleepHours: "6" },
    after: { revenue: "22000", responses: "100٪", sleepHours: "8" },
    growth: "267٪",
    duration: "2 شهر",
    quote: "في أول أسبوع بس، باعت دُكّاني عسل بـ3500 درهم في ليلة واحدة وأنا نايم. قلت إلى هذا حلم!",
    longStory: `أمين يملك مناحل في جنوب المغرب. كان يبيع عبر واتساب لكن لا يستطيع الرد في الليل على الطلبات.

في الأسبوع الأول مع دُكّاني، باع مخزون 5 أيام في ليلة واحدة. المساعد الذكي شرح أنواع العسل، فوائده، وأسعاره للعملاء الذين راسلوا في الساعة 11 ليلاً.

الآن يعتبر متجره أشهر متجر عسل في أكادير.`,
    tags: ["عسل", "أكادير", "منتجات طبيعية"],
    metrics: [
      { label: "مبيعات شهرية", before: "6000 د.م", after: "22000 د.م" },
      { label: "طلبات ليلية", before: "0", after: "18/شهر" },
      { label: "متوسط الطلب", before: "150 د.م", after: "380 د.م" },
      { label: "عملاء جدد", before: "3/أسبوع", after: "12/أسبوع" },
    ],
  },
];
      ...
      <main>
        ...
        <section className="py-12 bg-surface-2 px-6">
          <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              { value: "2000+", label: "قصة نجاح" },
              { value: "267٪", label: "متوسط نمو المبيعات" },
              { value: "4.9/5", label: "متوسط رضا العملاء" },
              { value: "98٪", label: "معدل الاحتفاظ بالتجار" },
            ].map((s, i) => (
