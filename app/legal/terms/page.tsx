...
const sections = [
  ...
  },
  {
    ...
    content: "أنت مسؤول عن الحفاظ على سرية بيانات تسجيل الدخول. يجب أن تكون فوق ١٨ عاماً. تمنع مشاركة الحساب مع أطراف أخرى. نحتفظ بحق تعليق الحسابات المخالفة.",
  },
  {
  ...
  {
    title: "٥. الاشتراكات والدفع",
    content: "تُجدَّد الاشتراكات تلقائياً في بداية كل دورة فوترة. يمكنك إلغاء الاشتراك في أي وقت. لا نسترد رسوم الأشهر المنقضية. نحتفظ بحق تعديل الأسعار مع إشعار مسبق ٣٠ يوماً.",
  },
  {
  ...
  },
  {
    ...
    content: "يمكنك إنهاء حسابك في أي وقت من الإعدادات. يمكننا تعليق أو إنهاء حسابات تنتهك هذه الشروط. عند الإنهاء، يمكنك تصدير بياناتك خلال ٣٠ يوماً.",
  },
  {
